"""
Generate data set that is best for linear regression learner.
"""
...
def generateData(N=1000):
    """
    For the Linear Regression learner to perform better, we need a
    model that fits the assumptions made by the linear regression learner.
    Namely, we need a linear function.
    
    I choose my linear function to be 4*X1 + 2*X2 = Y
